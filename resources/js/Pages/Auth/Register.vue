        ...
        <div class="card-body">
            ...
            <form @submit.prevent="submit">
                ...
                <div class="form-check">
                    <input class="form-check-input" name="is_shop" type="radio" id="is_shopFalse" value="0" v-model="form.is_shop">
                    <label class="form-check-label" for="is_shopFalse">
                        Пользователь
                    </label>
                </div>
                <div class="form-check">
                    <input class="form-check-input" name="is_shop" type="radio" id="is_shopTrue" value="1" v-model="form.is_shop">
                    <label class="form-check-label" for="is_shopTrue">
                        Магазин
                    </label>
                </div>
                <div class="form-group" v-if="$page.props.jetstream.hasTermsAndPrivacyPolicyFeature">
                    <div class="custom-control custom-checkbox">
                        ...
                        <label class="custom-control-label" for="terms">
                            I agree to the <a target="_blank" :href="route('terms.show')">Terms of Service</a> and <a
